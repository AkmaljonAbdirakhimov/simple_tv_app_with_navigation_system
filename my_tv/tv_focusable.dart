    ...
    switch (event.logicalKey) {
      ...
      case LogicalKeyboardKey.arrowLeft:
        if (widget.leftFocusKey != null) {
          final targetState = _scope?.findFocusable(widget.leftFocusKey!);
          if (targetState != null) {
      ...
      case LogicalKeyboardKey.arrowRight:
        if (widget.rightFocusKey != null) {
          final targetState = _scope?.findFocusable(widget.rightFocusKey!);
          if (targetState != null) {
            targetState._focusNode.requestFocus();
            widget.onRight?.call();
          }
      ...
      case LogicalKeyboardKey.arrowUp:
        if (widget.upFocusKey != null) {
          final targetState = _scope?.findFocusable(widget.upFocusKey!);
          if (targetState != null) {
            targetState._focusNode.requestFocus();
            widget.onUp?.call();
          }
      ...
      case LogicalKeyboardKey.arrowDown:
        if (widget.downFocusKey != null) {
          final targetState = _scope?.findFocusable(widget.downFocusKey!);
          if (targetState != null) {
            targetState._focusNode.requestFocus();
            widget.onDown?.call();
          }
...
class _TVFocusableScope extends InheritedWidget {
  ...
  _TVFocusableState? findFocusable(String key) => focusables[key];
